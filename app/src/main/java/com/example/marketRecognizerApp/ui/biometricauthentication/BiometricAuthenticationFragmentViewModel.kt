...
@HiltViewModel
class BiometricAuthenticationFragmentViewModel @Inject constructor(
    @ApplicationContext private val context: Context,
    @RoomDbBuilder private val db: AppDatabase,
    @RetrofitClientBuilder private val retrofitInterFace: RetrofitInterface
) : BaseViewModel() {

    var isWithPasswordClicked = CustomMutableSingleLiveData<Boolean>().default(false)

    fun withPasswordClicked() {
        isWithPasswordClicked.postValue(true)
    }
