...
class VerificationFragmentViewModel @Inject constructor(
    ...
    var isVerifyClicked = CustomMutableSingleLiveData<Boolean>().default(false)

    var email = CustomMutableSingleLiveData<String?>().default(null)


    fun verifyClicked() {
        isVerifyClicked.postValue(true)
    }
